...
function EslVerticalTab({
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-full">
      {/* Tabs */}
      <div className={`max-3md:p-6 max-sm:p-4 max-3md:rounded-xl max-sm:rounded-none max-sm:rounded-t-xl max-3md:bg-gray-50 dark:max-3md:bg-gray-700 max-3md:grid 3md:col-span-4 gap-6 ${position === "left" ? "grid-cols-[1fr_min-content]" : "3md:order-1 grid-cols-[min-content_1fr]"}`}>
      ...
      <div className="w-full min-h-48 aspect-4/2 relative rounded overflow-hidden bg-gray-100 dark:bg-gray-600">
        <Image
          src={featureData[activeFeatureIndex].img}
          alt={featureData[activeFeatureIndex].title}
          fill
