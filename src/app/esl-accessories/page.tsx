  ...
  return (
    <div className="w-full min-h-screen text-gray-900 dark:text-white">
      ...
      <section className="relative">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10 p-6 sm:p-8 2md:p-12 rounded-2xl">
          <FadeAnimation staggerChildren={0.3}>
            <h1 className="text-white dark:text-black text-3xl md:text-4xl lg:text-5xl xl:text-[56px] mb-4 font-bold">
            ...
            <p className="text-white dark:text-black text-base md:text-lg xl:text-xl">
